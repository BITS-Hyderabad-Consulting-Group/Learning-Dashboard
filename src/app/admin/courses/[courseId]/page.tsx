...
export default function CourseUpsertPage({ params }: { params: Promise<{ courseId: string }> }) {
    ...
    useEffect(() => {
        ...
        //
        //
        console.log(form, isDataLoaded, submitted, bannerPreview); // to be removed once backend is implemented
        setSubmitted(false); // to be removed once backend is implemented
        //
        //
    ...
    //                                 <BookOpen className="w-5 h-5 text-teal-500" /> General
    //                                 Information
    //                             </h2>
    ...
    //                                                         value={form.duration}
    //                                                         onChange={handleChange}
    //                                                         className="w-full border border-gray-200 rounded-lg px-4 py-2 bg-gray-100 text-base focus:outline-none focus:ring-2 focus:ring-teal-500 cursor-not-allowed"
    //                                                         disabled
    //                                                         readOnly
    //                                                     />
    //                                                 </div>
